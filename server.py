...
import logging
from Models import *
from Models.FaceRecognition import faceRecog
...
def FaceRecognition():
    ...
    session['uploadFilePath']=destination
    logger.info(destination)
    text = faceRecog("uploads/test_docs/input.jpg", "uploads/test_docs/output.jpg")
    response = jsonify({'dataOutput': 'output.jpg', 'dataInput': 'input.jpg', 'text': text['face_names']})
    return response
